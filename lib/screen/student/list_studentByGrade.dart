...
import 'package:preppa_profesores/providers/generateFiles.dart';
...
class _ScreenListStudentByGradesState extends State<ScreenListStudentByGrades> {
  ...
  Widget build(BuildContext context) {
    ...
    final generateFile = GenerateFiles();
    ...
    return Scaffold(
      floatingActionButton: ElevatedButton(
        onPressed: () async {
          ...
          // print('Ruta del archivo crado' + file.path);
          ...
          File file = await generateFile.generateFileForTopStudents(
              ratingServices, 'No se');

          // ignore: use_build_context_synchronously
          Navigator.pushNamed(context, 'view_pdf', arguments: file);
      ...
      appBar: AppBar(
        title: const Text('Estudiantes por calificacion'),
      ),
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return ListTile(
                          ...
                          title: Text(ratings[index].student.nameStudent),
